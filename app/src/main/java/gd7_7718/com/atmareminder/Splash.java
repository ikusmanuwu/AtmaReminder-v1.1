...
/**
 * Created by Daaavid on 5/30/2017.
 */
...
public class Splash extends AwesomeSplash{
   ...
   /* you don't have to override every property */
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.drawable.campusreminder); //or any other drawable
...
*/
        ...
        //Customize Title
        configSplash.setTitleSplash("Your Personal Reminder");
        configSplash.setTitleTextColor(R.color.fillColor);
        configSplash.setTitleTextSize(30f); //float value
        configSplash.setAnimTitleDuration(3000);
        configSplash.setAnimTitleTechnique(Techniques.FadeInLeft);
        //configSplash.setTitleFont("font/lakesight.ttf"); //provide string to your font located in assets/fonts/
